...
DROP TABLE orders_2024;`,
  ...
  keyPoints: [
    ...
    },
    {
      ...
      uk: "Shard key — це доля: він визначає, які запити single-shard (швидкі, ACID), а які scatter-gather. Вибирайте його для co-location повʼязаних рядків — ніколи за 'інтуїцією'.",
    },
    {
    ...
    },
    {
      ...
      uk: 'Cross-shard-записи потребують 2PC або sagas — та сама проблема блокування, що в M20. Co-location (той самий shard key для повʼязаних таблиць) тримає join\'и та записи локальними й уникає розподілених транзакцій за дизайном.',
    },
  ],
  pitfalls: [
    {
