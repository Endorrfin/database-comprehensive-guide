  ...
  keyPoints: [
    {
      ...
      uk: 'Document MongoDB — це BSON-об\'єкт (макс. 16 МБ) з вкладеними sub-documents і масивами; collection не enforced schema за замовчуванням.',
    },
    {
  ...
  pitfalls: [
    ...
    },
    {
      ...
      body: {
        ...
        uk: 'Кілька stages `$lookup`, що з\'єднують великі collections — сигнал, що ваші дані є реляційними. `$lookup` MongoDB — це left-outer join без оптимізації порядку join у планувальнику — потужний, але не заміна RDBMS для join-навантажень.',
      },
    },
  ],
