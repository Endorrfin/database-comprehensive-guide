        ...
        },
        {
          ...
          rows: [
            ...
            [
              ...
              { en: 'Same sequential order for all; no wall-clock constraint', uk: 'Один послідовний порядок для всіх; без прив\'язки до реального часу' },
              { en: 'No', uk: 'Ні' },
              { en: 'CPU memory models (x86 TSO)', uk: 'Моделі пам\'яті CPU (x86 TSO)' },
            ],
            [
              { en: 'Causal consistency', uk: 'Causal consistency' },
              { en: 'Causally related ops in order; concurrent ops unordered', uk: "Причинно пов'язані операції по порядку; паралельні — без порядку" },
              { en: 'No', uk: 'Ні' },
