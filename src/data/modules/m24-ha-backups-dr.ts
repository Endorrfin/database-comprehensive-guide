        ...
        },
        {
          ...
          rows: [
            ...
            [
              ...
              { en: '10 s', uk: '10 с' },
              { en: 'How often Patroni checks cluster health and renews the lock', uk: 'Як часто Patroni перевіряє здоров\'я кластера і оновлює lock' },
            ],
            [
      ...
      blocks: [
        ...
        },
        {
          ...
          rows: [
            ...
            [
              { en: 'Object store (S3/GCS/Azure)', uk: "Об'єктне сховище (S3/GCS/Azure)" },
              { en: 'No', uk: 'Ні' },
              { en: 'No', uk: 'Ні' },
  ...
  pitfalls: [
    ...
    },
    {
      ...
      body: {
        ...
        uk: "Гарячий standby, що реплікується асинхронно, може відставати на секунди. Він також негайно реплікує логічні помилки (DROP TABLE, пошкоджені дані). Standby — не backup, а HA-репліка. Якщо потрібен DR-захист від логічних помилок та людських помилок, підтримуйте окремий PITR backup в об'єктному сховищі. Деякі команди налаштовують **delayed standby** (`recovery_min_apply_delay`), що відтворює WAL із конфігурованою затримкою (наприклад, 1 година) — це дає вікно для виявлення помилок до їх розповсюдження, без відновлення з повного backup.",
      },
    },
    {
